...
extern bool nvwaDebugLoggingEnabled; ///ADDED BY SIMION32: DEBUGGING FLAG
...
//WARNING: COMPLEX GCC BEHAVIOR WORKAROUND FOR INCORRECT __LINE__ EXPANSION
#define DEBUG_NEW __debug_new_recorder("On line " __LINESTR__ " of " __FILE__, 1) ->* new
